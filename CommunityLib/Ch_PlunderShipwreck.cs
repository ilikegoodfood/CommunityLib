    ...
    public class Ch_PlunderShipwreck : Challenge
    {
        ...
        public void aiOutcome(UA ua)
        {
            ...
            else
            {
                ...
                if (Eleven.random.Next(2) == 0 && ModCore.Get().data.tryGetModAssembly("DeepOnesPlus", out ModData.ModIntegrationData intDataDOPlus) && intDataDOPlus.assembly != null && intDataDOPlus.typeDict.TryGetValue("Kernel", out Type kernelType) && kernelType != null)
                {
