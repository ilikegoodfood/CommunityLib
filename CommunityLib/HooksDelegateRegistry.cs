...
namespace CommunityLib
{
    public class HooksDelegateRegistry
    {
        ...
        private List<Func<Location, Location, Unit, List<Func<Location[], Location, Unit, double>>, List<Func<Location[], Location, Unit, List<Location>>>, bool>> _delegate_onPathfinding_AllowSecondPass = new List<Func<Location, Location, Unit, List<Func<Location[], Location, Unit, double>>, List<Func<Location[], Location, Unit, List<Location>>>, bool>>();
        public List<Func<Location, Location, Unit, List<Func<Location[], Location, Unit, double>>, List<Func<Location[], Location, Unit, List<Location>>>, bool>> Delegate_onPathfinding_AllowSecondPass { get { return _delegate_onPathfinding_AllowSecondPass; } }
        public bool RegisterHook_onPathfinding_AllowSecondPass(Func<Location, Location, Unit, List<Func<Location[], Location, Unit, double>>, List<Func<Location[], Location, Unit, List<Location>>>, bool> hook)
        {
            if (hook == null)
                return false;
