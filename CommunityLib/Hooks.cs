...
namespace CommunityLib
{
    public abstract class Hooks
    {
        ...
        public virtual void onPopulatingPathfindingDelegates(Location locA, Location LocB, Unit u, List<int> expectedMapLayers, List<Func<Location[], Location, Unit, List<int>, double>> pathfindingDelegates, List<Func<Location[], Location, Unit, List<int>, List<Location>>> getNeighbourDelegates)
        {
            return;
        }
        ...
        /// <param name="getNeighbourDelegates"></param>
        /// <returns></returns>
        public virtual bool onPathfinding_AllowSecondPass(Location locA, Location locB, Unit u, List<int> expectedMapLayers, List<Func<Location[], Location, Unit, List<int>, double>> pathfindingDelegates, List<Func<Location[], Location, Unit, List<int>, List<Location>>> getNeighbourDelegates)
        {
            return false;
        }
