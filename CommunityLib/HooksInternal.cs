...
namespace CommunityLib
{
    internal class HooksInternal
    {
        ...
        {
            if (subsettlement is Sub_Farms && subsettlement.settlement.location.hex.z == 1)
            {
                return "Living in the darkness of the world below makes for a suspicious and insular people, wary of any change to practices that have kept them safe for untold generations. Newcomers gain acceptance by proving their worth, whispering to the soft fungi and herding the eyeless creatures of the caves as if born from them. A new way of life emerges, and with it the cult offers liberation, a freedom in the dark that makes eyes shine with a light the surface could never provide.";
            }
